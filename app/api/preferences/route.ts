...
export async function GET(request:Request){
 ...
 return error?apiError(503,'Your saved places are temporarily unavailable.'):Response.json({saved:data?.saved_places||[],visited:data?.visited_places||[]},{headers:{'Cache-Control':'no-store'}});
